...
def main(args):
    dataset = load_dataset("lapa-llm/unlp-non-manipulative")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--target_column", type=str, default="manipulative")
    parser.add_argument(
        "--checkpoint_dir",
        type=str,
        default="./manipulative_score_checkpoints",
    )
    parser.add_argument(
        "--output_model_name", type=str, default="lapa-llm/manipulative-score-model"
    )
